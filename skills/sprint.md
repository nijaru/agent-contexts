...
- **Atomic:** Tasks must be single-concern and small enough to verify in one coherent change set.
...
Structure sprints to build incrementally. Avoid infrastructure-only sprints unless they produce a visible executable, testable endpoint, or working integration.
